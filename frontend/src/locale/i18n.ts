...
// import reactEn from '@fit-elsa/agent-flow/locales/en.json';
// import reactZh from '@fit-elsa/agent-flow/locales/zh.json';
...
const resources = {
  en: {
    translation: en // 优先级顺序: en > reactEn > coreEn
  },
  zh: {
    translation: zh // 优先级顺序: zh > reactZh > coreZh
  }
};
